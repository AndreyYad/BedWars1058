...
public class BlastProtectionUtil {
    ...
    public BlastProtectionUtil(VersionSupport versionSupport) {
    ...
    public boolean isProtected(@NotNull IArena arena, Location pov, @NotNull Block block, double step) {
        ...
        boolean rayBlockedByGlass = BedWars.getMainConfig().getBoolean(ConfigPath.GENERAL_TNT_RAY_BLOCKED_BY_GLASS);
