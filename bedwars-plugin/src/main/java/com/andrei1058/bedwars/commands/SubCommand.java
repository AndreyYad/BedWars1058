...
public abstract class SubCommand {
    ...
    public boolean canSee(CommandSender sender) {
        ...
        if (isArenaSetupCommand() && SetupSession.isInSetupSession(((Player) sender).getUniqueId())) return true;
        if (!isArenaSetupCommand() && SetupSession.isInSetupSession(((Player) sender).getUniqueId())) return false;
