...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        if (isFirstTime()) {
            ...
            Misc.addDefaultStatsItem(yml, 13, Material.SKELETON_SKULL, 0, "deaths");
            Misc.addDefaultStatsItem(yml, 14, Material.DIAMOND_SWORD, 0, "final-kills");
            Misc.addDefaultStatsItem(yml, 15, Material.SKELETON_SKULL, 1, "final-deaths");
            Misc.addDefaultStatsItem(yml, 16, Material.RED_BED, 0, "beds-destroyed");
            Misc.addDefaultStatsItem(yml, 21, Material.BLACK_STAINED_GLASS_PANE, 0, "first-play");
            Misc.addDefaultStatsItem(yml, 22, Material.CHEST, 0, "games-played");
            Misc.addDefaultStatsItem(yml, 23, Material.BLACK_STAINED_GLASS_PANE, 0, "last-play");
        }
