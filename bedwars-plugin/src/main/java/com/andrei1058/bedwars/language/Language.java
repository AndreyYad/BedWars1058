...
public class Language extends ConfigManager {
    ...
    public String m(String path) {
        ...
        if (null == serverIp) {
            if (null != BedWars.getMainConfig()) {
                serverIp = BedWars.getMainConfig().
    ...
    public static void setupCustomStatsMessages() {
        for (Language l : getLanguages()) {
            ...
            if (BedWars.getMainConfig().getYml().get(ConfigPath.GENERAL_CONFIGURATION_STATS_PATH) == null)
                return;
            for (String item : BedWars.getMainConfig().getYml().getConfigurationSection(ConfigPath.GENERAL_CONFIGURATION_STATS_PATH).getKeys(false)) {
    ...
    public static void addDefaultMessagesCommandItems(Language language) {
        ...
        if (yml == null) return;
        if (BedWars.getMainConfig().getYml().get(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_PATH) != null) {
            for (String item : BedWars.getMainConfig().getYml().getConfigurationSection(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_PATH).getKeys(false)) {
        ...
        if (BedWars.getMainConfig().getYml().get(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_PATH) != null) {
            for (String item : BedWars.getMainConfig().getYml().getConfigurationSection(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_PATH).getKeys(false)) {
                if (item.isEmpty()) continue;
        ...
        if (BedWars.getMainConfig().getYml().get(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_PATH) != null) {
            for (String item : BedWars.getMainConfig().getYml().getConfigurationSection(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_PATH).getKeys(false)) {
                if (item.isEmpty()) continue;
    ...
    public void setupUnSetCategories() {
        for (String s : BedWars.getShopConfig().getYml().getConfigurationSection("").getKeys(false)) {
            ...
            if (BedWars.getShopConfig().getYml().get(s + ConfigPath.SHOP_CATEGORY_CONTENT_PATH) == null)
                continue;
            for (String c : BedWars.getShopConfig().getYml().getConfigurationSection(s + ConfigPath.SHOP_CATEGORY_CONTENT_PATH).getKeys(false)) {
